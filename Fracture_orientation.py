...
u_inlet = 3.6E-3 # m/sec = 6000 cm/min)
...
#fracdata = [
#            [Length,fracwidth, 1.3, 0.2, 0.3],
#            [Length,fracwidth,0.9, 0.2, 0.2],
#            [Length,fracwidth, -1.3, 0.3, 0.2],
#            [Length,fracwidth, 0.7, 0.3, 0.15],
#            [Length,fracwidth, -0.6, 0.58, 0.3],
#            [Length,fracwidth, -1.3,  0.45, 0.35],
#            [Length,fracwidth, -0.1,  0.7, 0.18],
#            [Length,fracwidth, 0.7,  0.95, 0.36],
#            [Length,fracwidth, -0.7,  0.58, 0.05],
#            [Length,fracwidth, -1.3,  0.1, 0.23],
#            [Length,fracwidth, 0.6, 0.3, 0.3], 
#            [Length,fracwidth, 0.3,  0.5, 0.2],
#            [Length,fracwidth, -1.2, 0.15, 0.25],
#            [Length,fracwidth, 0.3, 0.8, 0.1],
#            [Length,fracwidth, -1.3, 0.93, 0.1]
#           ]
# 
  
#fracdata = [[0.00001,0.0001, 0.5,0, 0]] # no fracture
fracdata = [[0.3,0.0001, 0.005, 0.5, 0.2]] # Horizontal
#fracdata = [[0.3, 0.0001, 0.785, 0.5, 0.2]] # Diagonal
#fracdata = [[0.3,0.0001, math.pi/2,0.5, 0.2]] # Vertical
...
Pore_volume = Pore_volume +(Length*fracwidth)
